                ...
                <div className="section-4-content">
                    ...
                    <div className="rotating-div">
                        <div className="rotating-div-wrapper">
                            <div className="div1">
                                <img src={require(`../assets/images/green-chameleon-s9CC2SKySJM-unsplash.jpg`).default} alt="" />
                            </div>
                            <div className="div2">
                                <img src={require(`../assets/images/josefa-ndiaz-IzmdWT2lW5Q-unsplash-removebg-preview.png`).default} alt="" /> 
                            </div>
                            <div className="div3">
                                <img src={require(`../assets/images/markus-winkler-Kn_l9o5220Y-unsplash-removebg-preview.png`).default} alt="" />  
                            </div>
                            <div className="div4">
                                <img src={require(`../assets/images/sergey-zolkin-_UeY8aTI6d0-unsplash-removebg-preview (blue background).png`).default} alt="" />
                            </div>
                        </div>
                    </div>
