                ...
                <div className="section-4-content">
                    ...
                    <div className="rotating-div">
                        <div className="rotating-div-wrapper">
                            ...
                            <div className="div2">
                                <img src={require(`../assets/images/gery-wibowo-Eti6ph51H4A-unsplash.jpg`).default} alt="" /> 
                            </div>
                            <div className="div3">
                                <img src={require(`../assets/images/nick-morrison-FHnnjk1Yj7Y-unsplash.jpg`).default} alt="" />  
                            </div>
                            <div className="div4">
                                <img src={require(`../assets/images/sergey-zolkin-_UeY8aTI6d0-unsplash.jpg`).default} alt="" />
                            </div>
                        </div>
                    </div>
                    <span>We take every topic and teach in an easy and fun way.</span> 
                </div>
