        ...
        <div className="main-container">
            ...
            <section className="container-2">
               ...
               <div className="motor-wrapper">
                    <h2>Our at React Blog is to make people be the best versions of themselves they can be by writing on issues ranging from mental health to better learning habits and so on.
                    <span>
                        <button>Join</button>    
