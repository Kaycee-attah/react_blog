...
export default function Navigation(){
    ...
    return(
        ...
        <nav onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} onTouchMove={handleTouchMove} className={`Blog-Navigation ${navbarChanged && 'active'}`}>
