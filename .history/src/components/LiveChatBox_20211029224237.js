...
export default function LiveChatBox() {
    ...
    function mousedown(e) {
        ...
        function mousemove(e) {
            ...
            chatBoxRef.style.left = rect.left - newX + "px";
            chatBoxRef.style.top = rect.top - newY + "px";
    ...
    useEffect(() => {
        chatBoxRef.addEventListener("mousedown", mousedown);   
    })
    ...
    return (
       <Fragment>
           ...
           {liveChatBoxActive &&  <div ref={chatBoxRef} className={`chat-box-container  ${darkMode && "active"}`}>
