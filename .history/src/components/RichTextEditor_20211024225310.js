                ...
                <div className="editor-header">
                    ...
                    <div className="editor-post-category-container">
                        <div onClick={handleCategoriesMenu} className={`editor-post-category`}>
                            <span className="category-selector-text" style={{ color: categorySelected !== "Select a Category" && '#000', fontWeight: categorySelected !== "Select a Category" && '600' }}>{categorySelected}</span>
