...
export default function LiveChatBox() {
    ...
    return (
       <Fragment>
           ...
           {liveChatBoxActive &&  <div onMouseDown={handleMouseDown} onClick={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} style={styles} className={`chat-box-container ${darkMode && "active"}`}>
