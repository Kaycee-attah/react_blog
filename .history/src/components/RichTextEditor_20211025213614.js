...
export default function RichTextEditor() {
    ...
    const { blogTitleInputValue } = useContext(TextEditorInputValueContext);
    const { setBlogTitleInputValue } = useContext(TextEditorInputValueContext);
    const [image, setImage] = useState();
    const { textEditorInputValue } = useContext(TextEditorInputValueContext);
    const { setTextEditorInputValue } = useContext(TextEditorInputValueContext);
    const { categorySelected } = useContext(TextEditorInputValueContext);
    const { setCategorySelected } = useContext(TextEditorInputValueContext);
            ...
            <div className="text-editor-header">
                <div className="editor-header">
                    <div className="editor-post-title">
                        <input placeholder="Blog Title" onChange={(e) => {
                            setBlogTitleInputValue(e.target.value);
                            // console.log(blogTitleInputValue)
                        }} />
                    </div>
