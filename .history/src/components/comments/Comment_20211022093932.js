...
export default function Comment({ comment, replies, currentUserId, deleteComment, addComment, updateComment, repliedUserName, setRepliedUserName, activeLike, setActiveLike, activeDislike, setActiveDislike, activeComment, setActiveComment, parentId = null}) {
    ...
    const isLiked = activeLike && activeLike.type === 'liked' && activeComment.id === comment.id;
            ...
            <div className="comment-right-part">
                <div className="comment-content">
                    ...
                    <div className="comment-actions">
                        <div className="comment-action" style={{color: activeLike && 'blue'}} onClick={() => {
                            setActiveLike({ id: comment.id, type: "liked" })
                        
                            }}>Like</div>
                        <div className="comment-action" onClick={() => {
                            setActiveDislike({ id: comment.id, type: "disliked" })
                            }}>Dislike</div>
