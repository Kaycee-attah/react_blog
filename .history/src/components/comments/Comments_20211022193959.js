...
import { getComments as getCommentsApi, createComment as createCommentApi, updateComment as updateCommentApi, deleteComment as deleteCommentApi, updateLikeStatus as updateLikeStatusApi } from '../../api';
...
export default function Comments({ currentUserId }) {
    ...
    const rootComments = backendComments.filter((backendComments) => backendComments.parentId === null || undefined );
        ...
        updateLikeStatusApi(commentId).then(() => {
            const updatedBackendComments = backendComments.map(backendComment => {
                ...
                if(backendComment.id === commentId) {
                    // backendComment.push({ liked: true })
