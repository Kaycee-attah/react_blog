...
import { getComments as getCommentsApi, createComment as createCommentApi, updateComment as updateCommentApi, deleteComment as deleteCommentApi, updateLikeStatus as updateLikeStatusApi, updateDislikeStatus as updateDislikeStatusApi } from '../../api';
        ...
        updateDislikeStatusApi(commentId).then(() => {
            ...
            const updatedBackendComments = backendComments.map(backendComment => {
                ...
                if(backendComment.id === commentId) {
                    ...
                    if(backendComment.disliked === true) {
                        backendComment["no_of_dislikes"] = backendComment.no_of_dislikes + 1;
                    } else if(!backendComment.disliked) {
                        backendComment["no_of_dislikes"] = backendComment.no_of_dislikes - 1;
                    };
