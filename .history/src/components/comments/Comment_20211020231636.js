...
export default function Comment({ comment, replies, currentUserId, deleteComment, addComment, updateComment, repliedUserName, setRepliedUserName, activeComment, setActiveComment, parentId = null}) {
    ...
    const isReplying = activeComment && activeComment.type === 'replying' && activeComment.id === comment.id && initialText.slice(1) === username;
