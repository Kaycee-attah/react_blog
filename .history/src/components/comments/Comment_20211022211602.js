...
export default function Comment({ comment, replies, currentUserId, updateLikeStatus, deleteComment, addComment, updateComment, repliedUserName, setRepliedUserName, activeComment, setActiveComment, parentId = null}) {
            ...
            <div className="comment-right-part">
                <div className="comment-content">
                    ...
                    <div className="comment-actions">
                        <div className="comment-action" style={{ color: (comment.liked === true) ? 'blue' : "gold" }} onClick={() => {
