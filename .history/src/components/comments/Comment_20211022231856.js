...
export default function Comment({ comment, replies, currentUserId, updateLikeStatus, updateDislkeStatus, updateNo_Of_LikesStatus, deleteComment, addComment, updateComment, repliedUserName, setRepliedUserName, activeComment, setActiveComment, parentId = null}) {
            ...
            <div className="comment-right-part">
                <div className="comment-content">
                    ...
                    <div className="comment-actions">
                        ...
                        <div className="comment-action">{comment.no_of_likes}</div>
                        <div className="comment-action" style={{ color: (comment.disliked === true) ? 'blue' : "black" }} onClick={() => {
