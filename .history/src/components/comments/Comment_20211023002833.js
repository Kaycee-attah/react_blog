...
import { AiFillLike, AiFillDislikeAiFillDislike } from 'react-icons/ai'
            ...
            <div className="comment-right-part">
                <div className="comment-content">
                    ...
                    <div className="comment-actions">
                        <div className="comment-action" style={{ color: (comment.liked === true) ? 'blue' : "#999" }} onClick={() => {
                        ...
                        <div className="comment-action">{comment.no_of_dislikes}</div>
