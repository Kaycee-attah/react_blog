...
export default function Navigation(){
    ...
    return(
        ...
        <nav onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} onTouchMove={handleTouchMove} className={`${navbarChange ? 'Blog-Navigation-navbarChange' : navbarChangeAgain ? 'Blog-Navigation-navbarChangeAgain' : 'Blog-Navigation' }`}>
