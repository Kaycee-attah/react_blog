...
export default function RichTextEditor() {
    ...
    const { reactQuillRef } = useClick();
    const [, ] = useState(false);
    const { categoriesDropdownActive } = useClick();
    const { setCategoiesDropdownActive } = useClick();
    ...
    // const [, ] = useState("text-editor-container");
    const { inputActive } = useClick();
    const { setInputActive } = useClick();
    const { inputRef } = useClick();
    const { categoriesRef } = useClick();
    const { textEditorInputRef } = useClick();
    ...
    }, [setTextEditorInputValue, setBlogTitleInputValue, setCategorySelected, setImage]);
    ...
    function handleInputActive() {
        setInputActive("text-editor-container input-active")
    };
        ...
        <Fragment>
            <div className={inputActive}>
                <div className="text-editor-header">
                    <div className="editor-header">
                        <div className="editor-post-title">
                            <input ref={inputRef} placeholder="Blog Title" value={blogTitleInputValue} onChange={(e) => {
                                setBlogTitleInputValue(e.target.value);
                            }} onClick={handleInputActive} />
                        </div>
                        <div className="editor-post-category-container" ref={categoriesRef}>
                ...
                <div className="text-editor-wrapper">
                    <div className="text-editor" ref={textEditorInputRef} onClick={handleInputActive}>
                        <ReactQuill     
                            ref={reactQuillRef}
