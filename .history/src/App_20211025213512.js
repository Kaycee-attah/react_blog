          ...
          <sidebarContext.Provider value={{menuActive, setMenuActive}}>
            < settingsContext.Provider value={{settingsMenu, setSettingsMenu}} >
              <ClickedOutsideProvider>
                <SwipeProvider>
                  <ScrolledProvider>
                    <TextEditorInputValueContext.Provider value={{textEditorInputValue, blogTitleInputValue, categorySelected, setTextEditorInputValue, setBlogTitleInputValue, setCategorySelected}} >
                      <Navigation/>
                      <Switch>
